...
// script filter in the AlfKoreanSearch workflow. It dispatches by subcommand:
//
...
import (
	...
	"github.com/inchanS/AlfKoreanSearch/internal/handlers"
...
// argv in NFD (decomposed) form, but opendict.korean.go.kr expects NFC
